...
public class GameVisualizer extends JPanel implements Observed<GameVisualizerState>{
  ...
  public synchronized void setGameVisualizer(GameVisualizer target){
    m_robotPositionX = target.getM_robotPositionX();
    m_robotPositionY = target.getM_robotPositionY();
    m_robotDirection = target.getM_robotDirection();
    m_targetPositionX = target.getM_targetPositionX();
    m_targetPositionY = target.getM_targetPositionY();
  }
